"""
Inference Code for Validation Datasets

Single file Code that does the following
    1. Converts all the datasets to npy file
    2. Read the npy pickle file 
    3. Using the sequence classifier to find the accuracy
...
if __name__ == '__main__':
    ...
    npy_base_dir = "/4TBHD/ISL/CodeBase/Sequence_Model/seq_intern_npy_folder"
    ...
    test_data_path = '/4TBHD/ISL/data_preparation/intern_test_data'
    # test_data_path = '/4TBHD/ISL/data_preparation/seq_test_data'


    # Comment the below code if your dataset is already converted to pickle file
    construct_npy_dictionary(config,npy_base_dir,frame_tmp_dir,test_data_path,npy_pickle_path='intern_npy_dict.pkl')

    file_path = 'intern_npy_dict.pkl'
    ...
    construct_seq_dictionary(config,classification_dict,dataset_size,save_path='seq_intern_data.pkl')


    file_path_2 = 'seq_intern_data.pkl'
