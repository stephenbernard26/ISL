...
This code takes the npy files from the existing directory and then shifts the keypoints to a new 
origin. Please create the folder where the output needs to be saved before running the code. Example: normalised_keypoints
...
if __name__ == '__main__':
    # Example usage
    directory_path = '/4TBHD/ISL/data_preparation/test_all/keypoints' #Example path : /4TBHD/ISL/data_preparation/test_all/keypoints
