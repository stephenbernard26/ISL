...
def process_directory(dataset_dir,  frame_output_folder):
...
dataset_dir = "/4TBHD/Janaghan/5sign_5person"
...
frame_output_folder = "/4TBHD/5sign_5person_0.2_onlyface"
...
process_directory(dataset_dir, frame_output_folder)
